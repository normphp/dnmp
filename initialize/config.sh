...
export  CentreServePostDockerInfoRouter='/normphp/devops/nowadays/dnmp-remote-api.json'
# 中心服务接受 宿主机昨天 信息接口路由(这里默认配置的是normphp框架支持的api)
export  CentreServePostSystemInfoRouter='/normphp/devops/nowadays/dnmp-info.json'
# 配置环境容器
